    ...
    <div ref={containerRef} className="bg-obsidian">
      ...
      <section className="relative w-full overflow-hidden" style={{ height: '55vh', minHeight: '480px' }}>
        <div
          ...
          style={{ backgroundImage: `url(${chipBg})`, transformOrigin: 'center center' }}
        />
      ...
      {/* ===== News Highlights ===== */}
      {chainData?.newsHighlights && Object.keys(chainData.newsHighlights).length > 0 && (
        <section className="py-[100px] bg-obsidian">
          <div className="max-w-[1200px] mx-auto px-6 md:px-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {Object.entries(chainData.newsHighlights).map(([theme, items]) => (
